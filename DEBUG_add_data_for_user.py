...
search1 = Search([data_search1], uchicago_lat, uchicago_long, radius, 'Sample Search 1')
search2 = Search([data_search2], uchicago_lat, uchicago_long, radius, 'Sample Search 2')
